...
In this project, the chat shown is stored at the backend in the realtime database. The chat stored is reflected in the Chat.js component with the actual server time information. 
